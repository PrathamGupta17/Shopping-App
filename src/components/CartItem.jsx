...
const CartItem = ({item, itemIndex}) => {
  ...
  return (
    <div className="flex flex-col w-[450px] mt-6  justify-center items-center gap-16 h-[180px] rounded-[30px] shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] ">
      ...
      <div >
        <img src={item.image} className=" mt-4 h-[120px] w-[120px]" alt="//" />
      </div>

      <div className=" h-[1080px] ml-7">
      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <div onClick={removeFromCart} className="rounded-full   p-2 cursor-pointer border border-black bg-white ">
