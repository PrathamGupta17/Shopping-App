...
//               <button className=" text-lg w-full py-2.5 rounded-lg font-bold text-white bg-[#15803d] border-2 border-[#15830d] hover:bg-white hover:text-[#15830d] transition-all duration-300">Checkout Now</button>
//             </div>
//         </div>) :
//         (<div className=" w-screen h-[calc(100vh-80px)] flex flex-col gap-6 justify-center items-center ">
//           <h1 className=" font-[600] text-xl">Empty Cart</h1>
//           <Link to="/">
